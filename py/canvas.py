...
CATEGORY_TYPE = "NakuNodes/Utils"  # 更新类别为 Utils
...
NODE_CLASS_MAPPINGS = {
    "NakuNode_画布工具": NakuNode_画布工具,
    "NakuNode_画布": NakuNode_画布,
    "NakuNode_画布合成": NakuNode_画布合成,
    "NakuNode_变换数据": NakuNode_变换数据,
}
